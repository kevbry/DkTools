...
{
    class ConstMathTerm : ConstTerm
    {
        private Operator _op;
        private ConstTerm _left;
        private ConstTerm _right;

        public ConstMathTerm(Operator op, ConstTerm left, ConstTerm right, Span span)
            : base(span)
        {
            _op = op;
        ...
        public ConstMathTerm(BsonObject obj, Span span)
            : base(span)
        {
        ...
        public override DataType DataType => _left.DataType;
        ...
        internal override ConstValue ResolveConstantOrNull(ConstResolutionContext context, IEnumerable<string> circularDependencyCheckList)
        {
            ...
            var result = leftValue.GetMathResultOrNull(_op, rightValue, reportCollector);
            if (result != null)
            {
