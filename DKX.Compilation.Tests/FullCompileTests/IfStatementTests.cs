                ...
                Methods = new ObjectMethod[]
                {
                    new ObjectMethod
                    {
                        ...
                        Body = new ObjectBody
                        {
                            ...
                            Code = "asn($x,0),if(eq($x,0),(asn($x,1)))"
                        }
                    }
                }
            }, @"
                ...
                Methods = new ObjectMethod[]
                {
                    new ObjectMethod
                    {
                        ...
                        Body = new ObjectBody
                        {
                            ...
                            Code = "asn($x,0),if(eq($x,0),(asn($x,1)),,(asn($x,2)))"
                        }
                    }
                }
            }, @"
                ...
                Methods = new ObjectMethod[]
                {
                    new ObjectMethod
                    {
                        ...
                        Body = new ObjectBody
                        {
                            ...
                            Code = "asn($x,0),if(eq($x,0),(asn($x,1)),eq($x,1),(asn($x,2)),,(asn($x,3)))"
                        }
                    }
                }
            }, @"
                ...
                Methods = new ObjectMethod[]
                {
                    new ObjectMethod
                    {
                        ...
                        Body = new ObjectBody
                        {
                            ...
                            Code = "asn($x,0),if(eq($x,0),(asn($x,1)),eq($x,1),(asn($x,2)))"
                        }
                    }
                }
            }, @"
...
", null, null, expectedError: new ReportItem(@"x:\src\test.dkx", 5, 12, 5, 13, ErrorCode.IfConditionMustBeBool));
        }
    }
}
